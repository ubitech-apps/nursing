...
SP ".$page_start."
EP ".$page_end."
UR http://ubitech.xyz/material_innovation/#/current-issue/abstract/".$article_id."
PN ".$pages." ";

$fp = fopen("../admin/assets/bib_files/$articleno.txt","w");
fwrite($fp,$content);
fclose($fp);

header("Location: ../admin/assets/bib_files/mi".$article_id.".txt");
?>